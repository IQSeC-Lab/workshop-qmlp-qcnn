import os
# os.environ["CUDA_VISIBLE_DEVICES"] = "1" This if running it on the server
...
best_model = "qmlp-ember4-run3-mod.pt"
cm_name= "cm_qmlp-ember4-run3-mod.png"
############################################################################################################################################################################

data_train = np.load("../dataset/Ember-Class-100class/Ember-Class-100class_4_families_train.npz") 
