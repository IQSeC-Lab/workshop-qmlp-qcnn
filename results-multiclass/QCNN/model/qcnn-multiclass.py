...
best_model = "qcnn-API4-run2-mod.pt"
cm_name= "cm_qcnn-API4-run2-mod.png"
filename = "qcnn-API4-run2.txt"
...
data_train = np.load("../dataset/API_graph/APIgraph_train4-fam.npz") 
data_test = np.load("../dataset/API_graph/APIgraph_test4-fam.npz") 
