...
best_model = "qmlp-z-saved-models/AZ/qmlp-az23-run3-mod.pt"
cm_name= "cm_qmlp-az23-run3-mod.png"
filename = "qmlp-az23-run3.txt"
############################################################################################################################################################################

data_train = np.load("../dataset/AZ-Class-Task/AZ-Class-Task_4_families_train.npz") 
data_test = np.load("../dataset/AZ-Class-Task/AZ-Class-Task_4_families_test.npz") 
